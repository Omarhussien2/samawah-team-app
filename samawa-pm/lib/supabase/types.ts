  ...
  public: {
    Tables: {
      ...
      project_members: {
        ...
        Insert: Omit<Database["public"]["Tables"]["project_members"]["Row"], "id" | "created_at"> & { id?: string; created_at?: string };
      ...
      challenges: {
        ...
        Insert: Omit<Database["public"]["Tables"]["challenges"]["Row"], "id" | "created_at" | "updated_at"> & { id?: string; created_at?: string; updated_at?: string };
      ...
      documents: {
        ...
        Insert: Omit<Database["public"]["Tables"]["documents"]["Row"], "id" | "created_at"> & { id?: string; created_at?: string };
      ...
      automation_logs: {
        ...
        Insert: Omit<Database["public"]["Tables"]["automation_logs"]["Row"], "id" | "created_at"> & { id?: string; created_at?: string };
      ...
      project_templates: {
        ...
        Insert: Omit<Database["public"]["Tables"]["project_templates"]["Row"], "id" | "created_at"> & { id?: string; created_at?: string };
      ...
      task_templates: {
        ...
        Insert: Omit<Database["public"]["Tables"]["task_templates"]["Row"], "id"> & { id?: string };
